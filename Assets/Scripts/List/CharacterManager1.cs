...
public class CharacterManager1 : MonoBehaviour
{
    ...
    public void ChooseList()
    {
        ...
        Character.Add(new Character("≈‰≥¢2", 56, false, 0, false));
        Character.Add(new Character("≈‰≥¢2", 7, false, 0, false));
        Character.Add(new Character("≈‰≥¢4", 400, false, 0, false));
        Character.Add(new Character("≈‰≥¢4", 5, false, 0, false));
        Character.Add(new Character("¬˝Ω“≈‰≥¢", 10, false, 0, false));
        Character.Add(new Character("¬˝Ω“≈‰≥¢", 20, false, 0, false));
